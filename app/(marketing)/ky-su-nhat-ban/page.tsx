...
export const metadata: Metadata = {
  ...
  description: "Kết nối việc làm kỹ sư không mất phí tại Nhật Bản cho kỹ sư khối ngành kỹ thuật.",
};
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 lg:pl-4 flex flex-col items-start text-left order-2 lg:order-1">
              ...
              <a 
                href="#lead-form"
                className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold text-lg md:text-xl px-8 py-4 rounded-full shadow-[0_10px_20px_rgba(249,115,22,0.3)] hover:shadow-[0_15px_30px_rgba(249,115,22,0.4)] transition-all transform hover:-translate-y-1"
              >
                Nhận lộ trình & thông tin Job kỹ sư Nhật Bản
              </a>
            </div>
